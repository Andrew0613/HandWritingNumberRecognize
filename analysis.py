...
def analysis(dir,exp_name='dropout'):
    ...
    analysis picture of results
    """
    result_path = os.path.join(dir,exp_name)
    ...
    for path in paths:
        ...
        name = path
        dic = {'name':path,'acc':acc,'time_list':time,'time_total':time_total}
        dics.append(dic)
    make_fig(dics,exp_name=exp_name,mode='acc')
    make_fig(dics,exp_name=exp_name,mode='time')
if __name__ == "__main__":
    result_path = 'res_analysis'
    analysis(result_path,exp_name='dropout')
